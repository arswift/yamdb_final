...
- Склонируйте этот репозиторий в текущую папку git clone `https://github.com/arswift/yamdb_final/` .
...
Проект доступен по следующей ссылке <http://51.250.29.48/api/v1/>  
Подробная документация по API размещена по адресу <http://51.250.29.48/redoc/>